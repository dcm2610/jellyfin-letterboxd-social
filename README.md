...
```text
https://github.com/dcm2610/jellyfin-letterboxd-social/releases/download/v1.0.0.36/LetterboxdSocial_1.0.0.36.zip
```

Upload `dist/LetterboxdSocial_1.0.0.36.zip` as that release asset. Jellyfin can use the raw GitHub URL for `manifest.json` as a permanent update manifest.
